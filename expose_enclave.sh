...
sleep 5
# Secrets-block
SECRET_VALUE=$(aws secretsmanager get-secret-value --secret-id arn:aws:secretsmanager:us-east-1:977098992151:secret:weather-api-key-OUZJhz --region us-east-1 | jq -r .SecretString)
